...
from .gl_reviews import gl_reviews_view, balance_sheet_view, upload_gl_supporting_document, submit_gl_review
...
urlpatterns = [
    ...
    path('submit-review/', submit_gl_review, name='submit_gl_review'),
]
